...
/**
 * This type defines the fields that paginate the reports tasks returned by the
 * request. The entire result set consists of 0 or more sequenced response pages,
 * where each page consists of 0 or more items from the complete result set.
 */
class ReportTaskPagedCollection extends AbstractModel
{
    /**
     ...
     *
     * @var \Ebay\Sell\Marketing\Model\ReportTask[]
     */
    public $reportTasks = null;
}
